...
const SimpleDonutChart = ({ data, title = "Sales by Category", period = "This month vs last" }) => {
  ...
  // Create a simple donut visualization using flex
  return (
    <Surface style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.chartContainer}>
          {/* Simple donut representation using circular progress bars */}
